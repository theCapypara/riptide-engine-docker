...
class ContainerBuilderTest(unittest.TestCase):
    ...
    def test_command_list(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": [COMMAND, "elem2"]})
    ...
    def test_command_none(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": None})
        actual_api = test_obj.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)

        # Test CLI build
        expected_cli = self.expected_cli_base + ["-e", EENV_ON_LINUX + "=1", "--label", "riptide=1", IMAGE_NAME, ""]
        actual_cli = test_obj.build_docker_cli()
        self.assertListEqual(actual_cli, expected_cli)
    ...
    def test_command_list_spaces(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": [COMMAND, '"elem2 elem3"']})
        actual_api = test_obj.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_command_str_spaces_in_first_part_of_command(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": "elem1 elem2 elem3 \"elem4a elem4b\" 'elem5a elem5b'"})
        actual_api = test_obj.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
        ...
        expected_cli = self.expected_cli_base + [
            ...
            "riptide=1",
            IMAGE_NAME,
            "elem1 elem2 elem3 \"elem4a elem4b\" 'elem5a elem5b'",
        ]
        actual_cli = test_obj.build_docker_cli()
        self.assertListEqual(actual_cli, expected_cli)
    ...
    def test_set_env(self):
        ...
        # Test API build
        self.expected_api_base.update({"environment": {"test_key": "test_value", EENV_ON_LINUX: "1"}})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_label(self):
        ...
        # Test API build
        self.expected_api_base.update({"labels": {"riptide": "1", "test_key": "test_value"}})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_mount_not_mac(self, system_mock: Mock):
        ...
        expected_cli = self.expected_cli_base + [
            ...
            "riptide=1",
            "--mount",
            "type=bind,dst=/container_path,src=/host_path,ro=0",
            "--mount",
            "type=bind,dst=/container_path2,src=/host_path2,ro=1",
            IMAGE_NAME,
            COMMAND,
        ]
        actual_cli = self.fix.build_docker_cli()
    ...
    def test_set_mount_mac(self, system_mock: Mock):
        ...
        expected_cli = self.expected_cli_base + [
            ...
            "riptide=1",
            "--mount",
            "type=bind,dst=/container_path,src=/host_path,ro=0,consistency=delegated",
            "--mount",
            "type=bind,dst=/container_path2,src=/host_path2,ro=1,consistency=delegated",
            IMAGE_NAME,
            COMMAND,
        ]
        actual_cli = self.fix.build_docker_cli()
    ...
    def test_set_named_volume_mount(self, system_mock: Mock):
        ...
        self.expected_api_base.update(
            {
                ...
                "environment": {EENV_ON_LINUX: "1", EENV_NAMED_VOLUMES: "/container_path:/container_path2"},
            }
        )
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
        ...
        expected_cli = self.expected_cli_base + [
            ...
            "riptide=1",
            "--mount",
            "type=volume,target=/container_path,src=riptide__name,ro=0,volume-label=riptide=1",
            "--mount",
            "type=volume,target=/container_path2,src=riptide__name2,ro=1,volume-label=riptide=1",
            IMAGE_NAME,
            COMMAND,
        ]
        actual_cli = self.fix.build_docker_cli()
    ...
    def test_set_port(self):
        ...
        # Test API build
        self.expected_api_base.update({"ports": {1234: 5678, 9876: 5432}})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_network(self):
        ...
        # Test API build
        self.expected_api_base.update({"network": "name"})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_use_host_network(self):
        ...
        # Test API build
        self.expected_api_base.update({"network_mode": "host"})
    ...
    def test_set_name(self):
        ...
        # Test API build
        self.expected_api_base.update({"name": "blubbeldiblub"})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_entrypoint(self):
        ...
        # Test API build
        self.expected_api_base.update({"entrypoint": ["/usr/bin/very-important-script"]})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_args(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": COMMAND + ' "arg1" "arg2" "arg3"'})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_args_command_is_list(self):
        ...
        # Test API build
        self.expected_api_base.update({"command": [COMMAND, "arg0", "arg1", "arg2", "arg3"]})
    ...
    def test_set_hostname(self):
        ...
        # Test API build
        self.expected_api_base.update({"hostname": "dubdub"})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_set_workdir(self):
        ...
        # Test API build
        self.expected_api_base.update({"working_dir": "/tmp/blubbel"})
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
        ...
        self.expected_api_base.update(
            {
                ...
                "environment": {EENV_ORIGINAL_ENTRYPOINT: 'cmd "arg1" "arg2 with space"', EENV_ON_LINUX: "1"},
            }
        )
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
        ...
        self.expected_api_base.update(
            {
                ...
                "environment": {EENV_ORIGINAL_ENTRYPOINT: "", EENV_ON_LINUX: "1"},
            }
        )
        actual_api = self.fix.build_docker_api()
        self.assertDictEqual(actual_api, self.expected_api_base)
    ...
    def test_init_from_service_current_user(self, *args, **kwargs):
        ...
        service_stub.collect_environment = MagicMock(return_value={"key1": "value1", "key2": "value2"})
    ...
    def test_init_from_command(self, *args, **kwargs):
        ...
        command_stub.collect_environment = MagicMock(return_value={"key1": "value1", "key2": "value2"})
